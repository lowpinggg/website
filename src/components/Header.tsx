...
export function Header({
  ...
  console.log('Header - introComplete:', introComplete)
  ...
  return (
    ...
    className="origin-left mb-2 overflow-hidden"
  >
    <motion.div
      initial={{ y: '20vh' }}
      animate={{ y: '0' }} // You can adjust this value to control final position
      transition={{ duration: 1, ease: EASE, delay: 2 }}
      className="flex-col flex items-start justify-center gap-2 relative z-40 py-24 max-w-4xl"
    >
      ...
      <div className="overflow-hidden">
        <motion.h1
          className="overflow-hidden font-bold leading-[62px] text-6xl"
          ref={titleRef}
      ...
      <div className="max-w-2xl overflow-hidden">
        <motion.div
          ...
          custom={5.5}
        >
          <p className="text-base mb-8 text-muted-foreground font-light">
          ...
          <div className="flex items-center gap-2">
            <Button
              size="lg"
              className="bg-[#5763ED] text-white hover:bg-[#3744DB] rounded-full"
            >
              Discord
              <div>
                <svg
